...
Один файл содержит один инструмент. А пока что можно сделать как в [yndx_rub](graph_data/yndx_rub) — для построения графика используется данные другого графика.
...
### Roadmap:
  ...
  * [ ] сравнение нескольких облигаций на одном графике, например ОФЗ vs корпораты, сравнению дюрации
